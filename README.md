...
Coleção de projetos de modelagem matemática aplicada. Cada projeto parte de um problema real ou conceitual, formula-o matematicamente e o resolve-lo por métodos computacionais, estatísticos ou pela combinação dos dois, documentando todo o projeto.
...
- **Construir competência de forma cumulativa**: cada projeto é uma peça de método que se soma às anteriores.
- **Documentar com rigor**: todo projeto é tratado como um trabalho fechado, com formulação explícita, hipóteses declaradas e limitações, de modo que possa ser lido e reaproveitado.

---

## Escopo e Abordagens

Os projetos se distribuem entre três famílias de método:

### 1. Modelos de Primeiros Princípios
Modelos construídos a partir das leis fundamentais que governam o sistema, conservação de massa, energia e momento; equações de transporte e constitutivas. O comportamento é derivado da estrutura do problema.
...
Todo projeto, independentemente do tema, segue a mesma estrutura de documentação:
...
João Henrique Camargo Bernardi Miranda
